...
- /show_events – Показывает 5 последних событий, чтобы вы могли быстро оценить свою загрузку
...
Я здесь, чтобы сделать вашу жизнь более организованной и продуктивной. Начнем? 💪✨"""  # TODO
