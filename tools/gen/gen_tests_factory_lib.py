...
def make_data(
    ...
    **__: tp.Any,
    ...
    db_models = sorted(models.BaseModel.__subclasses__(), key=lambda m: m.__tablename__)  # type: ignore
    ...
    for model in db_models:
        ...
        data_for_gen[model.__tablename__] = gen_schemas.DataForGen(  # type: ignore
            template=template,
            recreate=True,
            gen_kwargs={
                'model': model,
